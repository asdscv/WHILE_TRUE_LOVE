...
export const config = {
  ...
  // 인사말
  // ---------------------------------------------------------
  // ⚠️ 01·초대 섹션은 완성 이미지(src/assets/sections/01-invite.webp) 한 장으로 표시됩니다.
  //    아래 문구는 화면에 렌더링되지 않고 이미지의 대체텍스트(스크린리더/검색)로만 쓰입니다.
  //    실제 보이는 문구를 고치려면 이미지 파일을 교체하세요.
  greeting: {
    title: '초대합니다',
...
축복해 주시면 감사하겠습니다.`,
  ...
  // 본문 중간 풀사이즈 사진 위에 얹히는 문구 (매거진 감성 밴드)
  photoQuote: '두 사람이 사랑으로\n하나 되는 날',
